...
\graphicspath{{./aux_demo_files/}} %the path here will be the default directory that \includegraphics looks for
...
\clearpage %prints all figures up to this point. Prevents text below this from cutting into an image. 
